...
#if 1 // added by iron
    SVF::NodeID mem_func_ptr_nid;
    SVF::NodeID this_adjusted_nid;
#endif
...
#if 1 // added by iron
    //SVF::NodeID mem_func_ptr_nid;
    //SVF::NodeID this_ajdusted_nid;
    inline SVF::NodeID getMemFuncPtrNid() const
    {
        return mem_func_ptr_nid;
    }

    inline SVF::NodeID getThisAdjustedNid() const
    {
        return this_adjusted_nid;
    }

    void setMemFuncPtrNid(SVF::NodeID nid)
    {
        mem_func_ptr_nid = nid;
    }

    void setThisAdjustedNid(SVF::NodeID nid)
    {
        this_adjusted_nid = nid;
    }

    //inline SVF::NodeID getThisA
#endif
