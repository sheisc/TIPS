...
#if 1 // added by iron
    static const Option<bool> OnlyI2PPtsPrint;
    static const Option<bool> PipAddI2PQuery;
    static const Option<bool> PipIndirectCalls;
    static const Option<bool> PipMemFuncPtrs;
    static const Option<bool> PipPrintStat;
    static const Option<bool> IntegerAsPointer;
    static const Option<bool> SelectiveIntegerAsPointer;
    static const Option<bool> AllAsPointer;
    static const Option<bool> PIPDebugOutput;
    static const Option<bool> PIPOutputFileAndLineNum;
    static const Option<bool> PipPreOnly;
    static const Option<bool> CompositionAnalysisOnly;
    static const Option<bool> CheckingVirFuncName;
    static const Option<bool> PipArrayOOB;
    static const Option<bool> VirtualCallAsIndirectCall;
    static const Option<bool> EnableLazyDiamond;
#endif
