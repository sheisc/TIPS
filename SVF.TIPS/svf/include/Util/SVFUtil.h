...
#define  NAME_OF_CXX_MEMBER_FUNC_PTR_THIS_ADJUSTED   "TIPS_load_"
#define  NAME_OF_CXX_MEMBER_FUNC_PTR_VTABLE_INDEX   "TIPS_load_"
#define  NAME_OF_CXX_VBASE_OFFSET                   "vbase.offset"
#define  NAME_OF_CXX_VBASE_OFFSET_PTR               "vbase.offset.ptr"
#define  PREFIX_OF_CXX_ZT_NAME                      "_ZT"
#define  NAME_OF_CXX_MEMPTR_VIRTUALFN               "memptr.virtualfn"
...
#if 1 // added by iron
bool isSVFDebugOutput();
bool outputFileAndLineNum();
bool enableAllAsPointer();
bool enableIntegerAsPointer();
bool isOnlyI2PPtsPrint();
unsigned getSizeOfPointerType();
bool isEnabled(const char *t);
SVFIR *getCurrentSVFIR();
bool isMemFuncPtrStruct(const SVFType *svfTy);
bool isVirtualFunction(const SVFFunction *func);
bool isNonVirtualFunction(const SVFFunction *func);
bool isThunkFunction(const SVFFunction *func);
#endif
