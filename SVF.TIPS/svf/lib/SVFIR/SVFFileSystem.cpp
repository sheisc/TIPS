...
cJSON* SVFIRWriter::contentToJson(const SVFVar* var)
{
    ...
    JSON_WRITE_FIELD(root, var, OutEdgeKindToSetMap);
    JSON_WRITE_FIELD(root, var, isPtr);
    JSON_WRITE_FIELD(root, var, asPointer);
...
cJSON* SVFIRWriter::toJson(const AccessPath& ls)
{
    ...
    cJSON* root = jsonCreateObject();
    JSON_WRITE_FIELD(root, &ls, fldIdx);
    JSON_WRITE_FIELD(root, &ls, btOffset);
    JSON_WRITE_FIELD(root, &ls, readjust);
    JSON_WRITE_FIELD(root, &ls, offsetVarAndGepTypePairs);
    return root;
#endif
}
...
void SVFIRReader::readJson(const cJSON* obj, AccessPath& ls)
{
    ...
    obj = obj->child;
    JSON_READ_FIELD_FWD(obj, &ls, fldIdx);
    JSON_READ_FIELD_FWD(obj, &ls, btOffset);
    JSON_READ_FIELD_FWD(obj, &ls, readjust);
    JSON_READ_FIELD_FWD(obj, &ls, offsetVarAndGepTypePairs);
    ABORT_IFNOT(!obj, "Extra field " << JSON_KEY(obj) << " in AccessPath");
#endif
}
...
void SVFIRReader::fill(const cJSON*& fieldJson, SVFVar* var)
{
    ...
    JSON_READ_FIELD_FWD(fieldJson, var, OutEdgeKindToSetMap);
    JSON_READ_FIELD_FWD(fieldJson, var, isPtr);
    JSON_READ_FIELD_FWD(fieldJson, var, asPointer);
#endif
}
