...
define dso_local void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dptr, i64 %mfptr.coerce0, i64 %mfptr.coerce1) #0 !dbg !254 {
entry:
  ...
  call void @llvm.dbg.value(metadata %class.DD* %dptr, metadata !261, metadata !DIExpression()), !dbg !262
  call void @llvm.dbg.value(metadata { i64, i64 } %mfptr1, metadata !263, metadata !DIExpression()), !dbg !262
  %memptr.adj = extractvalue { i64, i64 } %mfptr1, 1, !dbg !264
  %2 = bitcast %class.DD* %dptr to i8*, !dbg !264
  %3 = getelementptr inbounds i8, i8* %2, i64 %TIPS_load_01, !dbg !264
  %this.adjusted = bitcast i8* %3 to %class.DD*, !dbg !264
  %memptr.ptr = extractvalue { i64, i64 } %mfptr1, 0, !dbg !264
  %4 = and i64 %TIPS_load_00, 1, !dbg !264
  %memptr.isvirtual = icmp ne i64 %4, 0, !dbg !264
  br i1 %memptr.isvirtual, label %memptr.virtual, label %memptr.nonvirtual, !dbg !264

memptr.virtual:                                   ; preds = %entry
  %5 = bitcast %class.DD* %this.adjusted to i8**, !dbg !264
  %vtable = load i8*, i8** %5, align 8, !dbg !264
  %6 = sub i64 %TIPS_load_00, 1, !dbg !264
  %7 = getelementptr i8, i8* %vtable, i64 %6, !dbg !264, !nosanitize !260
  %8 = bitcast i8* %7 to void (%class.DD*)**, !dbg !264, !nosanitize !260
  %memptr.virtualfn = load void (%class.DD*)*, void (%class.DD*)** %8, align 8, !dbg !264, !nosanitize !260
  br label %memptr.end, !dbg !264

memptr.nonvirtual:                                ; preds = %entry
  %memptr.nonvirtualfn = inttoptr i64 %TIPS_load_00 to void (%class.DD*)*, !dbg !264
  br label %memptr.end, !dbg !264

memptr.end:                                       ; preds = %memptr.nonvirtual, %memptr.virtual
  %9 = phi void (%class.DD*)* [ %memptr.virtualfn, %memptr.virtual ], [ %memptr.nonvirtualfn, %memptr.nonvirtual ], !dbg !264
  call void %9(%class.DD* noundef nonnull align 8 dereferenceable(40) %this.adjusted) #6, !dbg !264
  ret void, !dbg !265
}
...
define dso_local noundef i32 @main() #2 !dbg !266 {
entry:
  %dobj = alloca %class.DD, align 8
  %coerce = alloca { i64, i64 }, align 8
  %coerce1 = alloca { i64, i64 }, align 8
  call void @llvm.dbg.declare(metadata %class.DD* %dobj, metadata !267, metadata !DIExpression()), !dbg !268
  call void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %dobj) #7, !dbg !268
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000000Ev to i64), i64 0 }, { i64, i64 }* %coerce, align 8, !dbg !269
  %1 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce, i32 0, i32 0, !dbg !269
  %2 = load i64, i64* %1, align 8, !dbg !269
  %3 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce, i32 0, i32 1, !dbg !269
  %4 = load i64, i64* %3, align 8, !dbg !269
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %2, i64 %4) #6, !dbg !269
  ...
  store i64 345, i64* %TIPS_gep_001, align 8
  store i64 0, i64* %TIPS_gep_012, align 8
  store { i64, i64 } { i64 345, i64 0 }, { i64, i64 }* %coerce1, align 8, !dbg !270
  %5 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce1, i32 0, i32 0, !dbg !270
  %6 = load i64, i64* %5, align 8, !dbg !270
  %7 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce1, i32 0, i32 1, !dbg !270
  %8 = load i64, i64* %7, align 8, !dbg !270
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %6, i64 %8) #6, !dbg !270
  ret i32 0, !dbg !271
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #3 comdat align 2 !dbg !272 {
entry:
  ...
  %1 = getelementptr inbounds i8, i8* %0, i64 40, !dbg !276
  %2 = bitcast i8* %1 to %class.AA*, !dbg !276
  call void @_ZN2AAC2Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %2) #7, !dbg !276
  %3 = bitcast %class.DD* %this to %class.BB*, !dbg !276
  %4 = getelementptr inbounds [7 x i8*], [7 x i8*]* @_ZTT2DD, i64 0, i64 1
  call void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %3, i8** noundef %4) #7, !dbg !276
  %5 = bitcast %class.DD* %this to i8*, !dbg !276
  %6 = getelementptr inbounds i8, i8* %5, i64 16, !dbg !276
  %7 = bitcast i8* %6 to %class.CC*, !dbg !276
  %8 = getelementptr inbounds [7 x i8*], [7 x i8*]* @_ZTT2DD, i64 0, i64 3
  call void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %7, i8** noundef %8) #7, !dbg !276
  %9 = bitcast %class.DD* %this to i32 (...)***, !dbg !276
  %10 = getelementptr inbounds { [66 x i8*], [23 x i8*], [42 x i8*] }, { [66 x i8*], [23 x i8*], [42 x i8*] }* @_ZTV2DD, i32 0, i32 0, i32 3
  %11 = bitcast i8** %10 to i32 (...)**
  store i32 (...)** %11, i32 (...)*** %9, align 8, !dbg !276
  %12 = bitcast %class.DD* %this to i8*, !dbg !276
  %add.ptr = getelementptr inbounds i8, i8* %12, i64 40, !dbg !276
  %13 = bitcast i8* %add.ptr to i32 (...)***, !dbg !276
  %14 = getelementptr inbounds { [66 x i8*], [23 x i8*], [42 x i8*] }, { [66 x i8*], [23 x i8*], [42 x i8*] }* @_ZTV2DD, i32 0, i32 2, i32 22
  %15 = bitcast i8** %14 to i32 (...)**
  store i32 (...)** %15, i32 (...)*** %13, align 8, !dbg !276
  %16 = bitcast %class.DD* %this to i8*, !dbg !276
  %add.ptr2 = getelementptr inbounds i8, i8* %16, i64 16, !dbg !276
  %17 = bitcast i8* %add.ptr2 to i32 (...)***, !dbg !276
  %18 = getelementptr inbounds { [66 x i8*], [23 x i8*], [42 x i8*] }, { [66 x i8*], [23 x i8*], [42 x i8*] }* @_ZTV2DD, i32 0, i32 1, i32 3
  %19 = bitcast i8** %18 to i32 (...)**
  store i32 (...)** %19, i32 (...)*** %17, align 8, !dbg !276
  ret void, !dbg !276
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !277 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AAC2Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #3 comdat align 2 !dbg !281 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !283, metadata !DIExpression()), !dbg !285
  %0 = bitcast %class.AA* %this to i32 (...)***, !dbg !286
  %1 = getelementptr inbounds { [22 x i8*] }, { [22 x i8*] }* @_ZTV2AA, i32 0, i32 0, i32 2
  %2 = bitcast i8** %1 to i32 (...)**
  store i32 (...)** %2, i32 (...)*** %0, align 8, !dbg !286
  ret void, !dbg !286
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !287 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !289, metadata !DIExpression()), !dbg !291
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !292, metadata !DIExpression()), !dbg !291
  %0 = load i8*, i8** %vtt, align 8, !dbg !295
  %1 = bitcast %class.BB* %this to i32 (...)***, !dbg !295
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !295
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !295
  %3 = getelementptr inbounds i8*, i8** %vtt, i64 1, !dbg !295
  %4 = load i8*, i8** %3, align 8, !dbg !295
  %5 = bitcast %class.BB* %this to i8**, !dbg !295
  %vtable = load i8*, i8** %5, align 8, !dbg !295
  %vbase.offset.ptr = getelementptr i8, i8* %vtable, i64 -24, !dbg !295
  %6 = bitcast i8* %vbase.offset.ptr to i64*, !dbg !295
  %vbase.offset = load i64, i64* %6, align 8, !dbg !295
  %7 = bitcast %class.BB* %this to i8*, !dbg !295
  %add.ptr = getelementptr inbounds i8, i8* %7, i64 %vbase.offset, !dbg !295
  %8 = bitcast i8* %add.ptr to i32 (...)***, !dbg !295
  %9 = bitcast i8* %4 to i32 (...)**, !dbg !295
  store i32 (...)** %9, i32 (...)*** %8, align 8, !dbg !295
  ret void, !dbg !295
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !296 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !298, metadata !DIExpression()), !dbg !300
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !301, metadata !DIExpression()), !dbg !300
  %0 = load i8*, i8** %vtt, align 8, !dbg !302
  %1 = bitcast %class.CC* %this to i32 (...)***, !dbg !302
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !302
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !302
  %3 = getelementptr inbounds i8*, i8** %vtt, i64 1, !dbg !302
  %4 = load i8*, i8** %3, align 8, !dbg !302
  %5 = bitcast %class.CC* %this to i8**, !dbg !302
  %vtable = load i8*, i8** %5, align 8, !dbg !302
  %vbase.offset.ptr = getelementptr i8, i8* %vtable, i64 -24, !dbg !302
  %6 = bitcast i8* %vbase.offset.ptr to i64*, !dbg !302
  %vbase.offset = load i64, i64* %6, align 8, !dbg !302
  %7 = bitcast %class.CC* %this to i8*, !dbg !302
  %add.ptr = getelementptr inbounds i8, i8* %7, i64 %vbase.offset, !dbg !302
  %8 = bitcast i8* %add.ptr to i32 (...)***, !dbg !302
  %9 = bitcast i8* %4 to i32 (...)**, !dbg !302
  store i32 (...)** %9, i32 (...)*** %8, align 8, !dbg !302
  ret void, !dbg !302
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !303 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !307 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !311 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !315 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000004Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !319 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000005Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !323 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000006Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !327 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000007Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !331 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000008Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !335 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000009Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !339 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000010Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !343 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000011Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !347 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000012Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !351 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000013Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !355 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000014Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !359 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000015Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !363 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000016Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !367 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13gg_v_00000017Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !371 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000018Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !375 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000019Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !379 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !383 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !387 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !391 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !395 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000004Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !399 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000005Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !403 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000006Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !407 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000007Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !411 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000008Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !415 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000009Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !419 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000010Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !423 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000011Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !427 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13kk_v_00000012Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !431 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !435 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !439 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !443 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !447 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000004Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !451 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000005Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !455 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000006Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !459 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000007Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !463 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000008Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !467 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13hh_v_00000009Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !471 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !475 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !479 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !483 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !487 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000004Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !491 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000005Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !495 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000006Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !499 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000007Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !503 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000008Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !507 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000009Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !511 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000010Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !515 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000011Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !519 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000012Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !523 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000013Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !527 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000014Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !531 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000015Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !535 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000016Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !539 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000017Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !543 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000018Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !547 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD13ff_v_00000019Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #4 comdat align 2 !dbg !551 {
entry:
...
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000000Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !555 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !557
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !557
  %2 = bitcast i8* %1 to %class.DD*, !dbg !557
  tail call void @_ZN2DD13hh_v_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !557
  ret void, !dbg !557
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000001Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !558 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !559
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !559
  %2 = bitcast i8* %1 to %class.DD*, !dbg !559
  tail call void @_ZN2DD13hh_v_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !559
  ret void, !dbg !559
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000002Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !560 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !561
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !561
  %2 = bitcast i8* %1 to %class.DD*, !dbg !561
  tail call void @_ZN2DD13hh_v_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !561
  ret void, !dbg !561
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000003Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !562 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !563
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !563
  %2 = bitcast i8* %1 to %class.DD*, !dbg !563
  tail call void @_ZN2DD13hh_v_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !563
  ret void, !dbg !563
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000004Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !564 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !565
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !565
  %2 = bitcast i8* %1 to %class.DD*, !dbg !565
  tail call void @_ZN2DD13hh_v_00000004Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !565
  ret void, !dbg !565
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000005Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !566 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !567
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !567
  %2 = bitcast i8* %1 to %class.DD*, !dbg !567
  tail call void @_ZN2DD13hh_v_00000005Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !567
  ret void, !dbg !567
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000006Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !568 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !569
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !569
  %2 = bitcast i8* %1 to %class.DD*, !dbg !569
  tail call void @_ZN2DD13hh_v_00000006Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !569
  ret void, !dbg !569
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000007Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !570 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !571
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !571
  %2 = bitcast i8* %1 to %class.DD*, !dbg !571
  tail call void @_ZN2DD13hh_v_00000007Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !571
  ret void, !dbg !571
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000008Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !572 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !573
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !573
  %2 = bitcast i8* %1 to %class.DD*, !dbg !573
  tail call void @_ZN2DD13hh_v_00000008Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !573
  ret void, !dbg !573
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZThn16_N2DD13hh_v_00000009Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !574 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !575
  %1 = getelementptr inbounds i8, i8* %0, i64 -16, !dbg !575
  %2 = bitcast i8* %1 to %class.DD*, !dbg !575
  tail call void @_ZN2DD13hh_v_00000009Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %2) #6, !dbg !575
  ret void, !dbg !575
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000010Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !576 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000011Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !580 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000012Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !584 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000013Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !588 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000014Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !592 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000015Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !596 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !597, metadata !DIExpression()), !dbg !598
  ret void, !dbg !599
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000016Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !600 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !601, metadata !DIExpression()), !dbg !602
  ret void, !dbg !603
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000017Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !604 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !605, metadata !DIExpression()), !dbg !606
  ret void, !dbg !607
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000018Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !608 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !609, metadata !DIExpression()), !dbg !610
  ret void, !dbg !611
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000019Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !612 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !613, metadata !DIExpression()), !dbg !614
  ret void, !dbg !615
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n24_N2DD13kk_v_00000000Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !616 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !617
  %1 = bitcast i8* %0 to i8**, !dbg !617
  %2 = load i8*, i8** %1, align 8, !dbg !617
  %3 = getelementptr inbounds i8, i8* %2, i64 -24, !dbg !617
  %4 = bitcast i8* %3 to i64*, !dbg !617
  %5 = load i64, i64* %4, align 8, !dbg !617
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !617
  %7 = bitcast i8* %6 to %class.DD*, !dbg !617
  tail call void @_ZN2DD13kk_v_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !617
  ret void, !dbg !617
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n32_N2DD13kk_v_00000001Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !618 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !619
  %1 = bitcast i8* %0 to i8**, !dbg !619
  %2 = load i8*, i8** %1, align 8, !dbg !619
  %3 = getelementptr inbounds i8, i8* %2, i64 -32, !dbg !619
  %4 = bitcast i8* %3 to i64*, !dbg !619
  %5 = load i64, i64* %4, align 8, !dbg !619
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !619
  %7 = bitcast i8* %6 to %class.DD*, !dbg !619
  tail call void @_ZN2DD13kk_v_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !619
  ret void, !dbg !619
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n40_N2DD13kk_v_00000002Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !620 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !621
  %1 = bitcast i8* %0 to i8**, !dbg !621
  %2 = load i8*, i8** %1, align 8, !dbg !621
  %3 = getelementptr inbounds i8, i8* %2, i64 -40, !dbg !621
  %4 = bitcast i8* %3 to i64*, !dbg !621
  %5 = load i64, i64* %4, align 8, !dbg !621
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !621
  %7 = bitcast i8* %6 to %class.DD*, !dbg !621
  tail call void @_ZN2DD13kk_v_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !621
  ret void, !dbg !621
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n48_N2DD13kk_v_00000003Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !622 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !623
  %1 = bitcast i8* %0 to i8**, !dbg !623
  %2 = load i8*, i8** %1, align 8, !dbg !623
  %3 = getelementptr inbounds i8, i8* %2, i64 -48, !dbg !623
  %4 = bitcast i8* %3 to i64*, !dbg !623
  %5 = load i64, i64* %4, align 8, !dbg !623
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !623
  %7 = bitcast i8* %6 to %class.DD*, !dbg !623
  tail call void @_ZN2DD13kk_v_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !623
  ret void, !dbg !623
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n56_N2DD13kk_v_00000004Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !624 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !625
  %1 = bitcast i8* %0 to i8**, !dbg !625
  %2 = load i8*, i8** %1, align 8, !dbg !625
  %3 = getelementptr inbounds i8, i8* %2, i64 -56, !dbg !625
  %4 = bitcast i8* %3 to i64*, !dbg !625
  %5 = load i64, i64* %4, align 8, !dbg !625
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !625
  %7 = bitcast i8* %6 to %class.DD*, !dbg !625
  tail call void @_ZN2DD13kk_v_00000004Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !625
  ret void, !dbg !625
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n64_N2DD13kk_v_00000005Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !626 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !627
  %1 = bitcast i8* %0 to i8**, !dbg !627
  %2 = load i8*, i8** %1, align 8, !dbg !627
  %3 = getelementptr inbounds i8, i8* %2, i64 -64, !dbg !627
  %4 = bitcast i8* %3 to i64*, !dbg !627
  %5 = load i64, i64* %4, align 8, !dbg !627
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !627
  %7 = bitcast i8* %6 to %class.DD*, !dbg !627
  tail call void @_ZN2DD13kk_v_00000005Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !627
  ret void, !dbg !627
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n72_N2DD13kk_v_00000006Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !628 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !629
  %1 = bitcast i8* %0 to i8**, !dbg !629
  %2 = load i8*, i8** %1, align 8, !dbg !629
  %3 = getelementptr inbounds i8, i8* %2, i64 -72, !dbg !629
  %4 = bitcast i8* %3 to i64*, !dbg !629
  %5 = load i64, i64* %4, align 8, !dbg !629
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !629
  %7 = bitcast i8* %6 to %class.DD*, !dbg !629
  tail call void @_ZN2DD13kk_v_00000006Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !629
  ret void, !dbg !629
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n80_N2DD13kk_v_00000007Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !630 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !631
  %1 = bitcast i8* %0 to i8**, !dbg !631
  %2 = load i8*, i8** %1, align 8, !dbg !631
  %3 = getelementptr inbounds i8, i8* %2, i64 -80, !dbg !631
  %4 = bitcast i8* %3 to i64*, !dbg !631
  %5 = load i64, i64* %4, align 8, !dbg !631
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !631
  %7 = bitcast i8* %6 to %class.DD*, !dbg !631
  tail call void @_ZN2DD13kk_v_00000007Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !631
  ret void, !dbg !631
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n88_N2DD13kk_v_00000008Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !632 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !633
  %1 = bitcast i8* %0 to i8**, !dbg !633
  %2 = load i8*, i8** %1, align 8, !dbg !633
  %3 = getelementptr inbounds i8, i8* %2, i64 -88, !dbg !633
  %4 = bitcast i8* %3 to i64*, !dbg !633
  %5 = load i64, i64* %4, align 8, !dbg !633
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !633
  %7 = bitcast i8* %6 to %class.DD*, !dbg !633
  tail call void @_ZN2DD13kk_v_00000008Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !633
  ret void, !dbg !633
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n96_N2DD13kk_v_00000009Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !634 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !635
  %1 = bitcast i8* %0 to i8**, !dbg !635
  %2 = load i8*, i8** %1, align 8, !dbg !635
  %3 = getelementptr inbounds i8, i8* %2, i64 -96, !dbg !635
  %4 = bitcast i8* %3 to i64*, !dbg !635
  %5 = load i64, i64* %4, align 8, !dbg !635
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !635
  %7 = bitcast i8* %6 to %class.DD*, !dbg !635
  tail call void @_ZN2DD13kk_v_00000009Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !635
  ret void, !dbg !635
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n104_N2DD13kk_v_00000010Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !636 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !637
  %1 = bitcast i8* %0 to i8**, !dbg !637
  %2 = load i8*, i8** %1, align 8, !dbg !637
  %3 = getelementptr inbounds i8, i8* %2, i64 -104, !dbg !637
  %4 = bitcast i8* %3 to i64*, !dbg !637
  %5 = load i64, i64* %4, align 8, !dbg !637
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !637
  %7 = bitcast i8* %6 to %class.DD*, !dbg !637
  tail call void @_ZN2DD13kk_v_00000010Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !637
  ret void, !dbg !637
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n112_N2DD13kk_v_00000011Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !638 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !639
  %1 = bitcast i8* %0 to i8**, !dbg !639
  %2 = load i8*, i8** %1, align 8, !dbg !639
  %3 = getelementptr inbounds i8, i8* %2, i64 -112, !dbg !639
  %4 = bitcast i8* %3 to i64*, !dbg !639
  %5 = load i64, i64* %4, align 8, !dbg !639
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !639
  %7 = bitcast i8* %6 to %class.DD*, !dbg !639
  tail call void @_ZN2DD13kk_v_00000011Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !639
  ret void, !dbg !639
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZTv0_n120_N2DD13kk_v_00000012Ev(%class.DD* noundef %this) unnamed_addr #5 comdat align 2 !dbg !640 {
entry:
  %0 = bitcast %class.DD* %this to i8*, !dbg !641
  %1 = bitcast i8* %0 to i8**, !dbg !641
  %2 = load i8*, i8** %1, align 8, !dbg !641
  %3 = getelementptr inbounds i8, i8* %2, i64 -120, !dbg !641
  %4 = bitcast i8* %3 to i64*, !dbg !641
  %5 = load i64, i64* %4, align 8, !dbg !641
  %6 = getelementptr inbounds i8, i8* %0, i64 %5, !dbg !641
  %7 = bitcast i8* %6 to %class.DD*, !dbg !641
  tail call void @_ZN2DD13kk_v_00000012Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %7) #6, !dbg !641
  ret void, !dbg !641
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000013Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !642 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !643, metadata !DIExpression()), !dbg !644
  ret void, !dbg !645
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000014Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !646 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !647, metadata !DIExpression()), !dbg !648
  ret void, !dbg !649
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000015Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !650 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !651, metadata !DIExpression()), !dbg !652
  ret void, !dbg !653
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000016Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !654 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !655, metadata !DIExpression()), !dbg !656
  ret void, !dbg !657
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000017Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !658 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !659, metadata !DIExpression()), !dbg !660
  ret void, !dbg !661
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000018Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !662 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !663, metadata !DIExpression()), !dbg !664
  ret void, !dbg !665
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000019Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !666 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !667, metadata !DIExpression()), !dbg !668
  ret void, !dbg !669
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000000Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !670 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000001Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !674 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000002Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !678 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000003Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !682 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000004Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !686 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000005Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !690 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000006Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !694 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000007Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !698 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000008Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !702 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CC13hh_v_00000009Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !706 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000000Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !710 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !711, metadata !DIExpression()), !dbg !712
  ret void, !dbg !713
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000001Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !714 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !715, metadata !DIExpression()), !dbg !716
  ret void, !dbg !717
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000002Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !718 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !719, metadata !DIExpression()), !dbg !720
  ret void, !dbg !721
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000003Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !722 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !723, metadata !DIExpression()), !dbg !724
  ret void, !dbg !725
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000004Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !726 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !727, metadata !DIExpression()), !dbg !728
  ret void, !dbg !729
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000005Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !730 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !731, metadata !DIExpression()), !dbg !732
  ret void, !dbg !733
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000006Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !734 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !735, metadata !DIExpression()), !dbg !736
  ret void, !dbg !737
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000007Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !738 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !739, metadata !DIExpression()), !dbg !740
  ret void, !dbg !741
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000008Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !742 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !743, metadata !DIExpression()), !dbg !744
  ret void, !dbg !745
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000009Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !746 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !747, metadata !DIExpression()), !dbg !748
  ret void, !dbg !749
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000010Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !750 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !751, metadata !DIExpression()), !dbg !752
  ret void, !dbg !753
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000011Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !754 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !755, metadata !DIExpression()), !dbg !756
  ret void, !dbg !757
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2AA13kk_v_00000012Ev(%class.AA* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !758 {
entry:
  call void @llvm.dbg.value(metadata %class.AA* %this, metadata !759, metadata !DIExpression()), !dbg !760
  ret void, !dbg !761
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000000Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !762 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !763, metadata !DIExpression()), !dbg !764
  ret void, !dbg !765
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000001Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !766 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !767, metadata !DIExpression()), !dbg !768
  ret void, !dbg !769
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000002Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !770 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !771, metadata !DIExpression()), !dbg !772
  ret void, !dbg !773
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000003Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !774 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !775, metadata !DIExpression()), !dbg !776
  ret void, !dbg !777
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000004Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !778 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !779, metadata !DIExpression()), !dbg !780
  ret void, !dbg !781
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000005Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !782 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !783, metadata !DIExpression()), !dbg !784
  ret void, !dbg !785
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000006Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !786 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !787, metadata !DIExpression()), !dbg !788
  ret void, !dbg !789
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000007Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !790 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !791, metadata !DIExpression()), !dbg !792
  ret void, !dbg !793
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000008Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !794 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !795, metadata !DIExpression()), !dbg !796
  ret void, !dbg !797
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000009Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !798 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !799, metadata !DIExpression()), !dbg !800
  ret void, !dbg !801
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000010Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !802 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !803, metadata !DIExpression()), !dbg !804
  ret void, !dbg !805
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000011Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !806 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !807, metadata !DIExpression()), !dbg !808
  ret void, !dbg !809
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000012Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !810 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !811, metadata !DIExpression()), !dbg !812
  ret void, !dbg !813
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000013Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !814 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !815, metadata !DIExpression()), !dbg !816
  ret void, !dbg !817
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000014Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !818 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !819, metadata !DIExpression()), !dbg !820
  ret void, !dbg !821
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000015Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !822 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !823, metadata !DIExpression()), !dbg !824
  ret void, !dbg !825
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000016Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !826 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !827, metadata !DIExpression()), !dbg !828
  ret void, !dbg !829
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BB13gg_v_00000017Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #4 comdat align 2 !dbg !830 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !831, metadata !DIExpression()), !dbg !832
  ret void, !dbg !833
}
