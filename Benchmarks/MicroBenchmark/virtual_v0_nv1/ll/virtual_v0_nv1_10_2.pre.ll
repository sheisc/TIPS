...
define linkonce_odr dso_local void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #3 comdat align 2 !dbg !110 {
entry:
  call void @llvm.dbg.value(metadata %class.DD* %this, metadata !112, metadata !DIExpression()), !dbg !113
  %0 = bitcast %class.DD* %this to i8*, !dbg !114
  %1 = getelementptr inbounds i8, i8* %0, i64 40, !dbg !114
  %2 = bitcast i8* %1 to %class.AA*, !dbg !114
  %3 = bitcast %class.DD* %this to %class.BB*, !dbg !114
  %4 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 1
  call void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %3, i8** noundef %4) #6, !dbg !114
  %5 = bitcast %class.DD* %this to i8*, !dbg !114
  %6 = getelementptr inbounds i8, i8* %5, i64 16, !dbg !114
  %7 = bitcast i8* %6 to %class.CC*, !dbg !114
  %8 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 2
  call void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %7, i8** noundef %8) #6, !dbg !114
  %9 = bitcast %class.DD* %this to i32 (...)***, !dbg !114
  %10 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 0, i32 3
  %11 = bitcast i8** %10 to i32 (...)**
  store i32 (...)** %11, i32 (...)*** %9, align 8, !dbg !114
  %12 = bitcast %class.DD* %this to i8*, !dbg !114
  %add.ptr = getelementptr inbounds i8, i8* %12, i64 16, !dbg !114
  %13 = bitcast i8* %add.ptr to i32 (...)***, !dbg !114
  %14 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 1, i32 3
  %15 = bitcast i8** %14 to i32 (...)**
  store i32 (...)** %15, i32 (...)*** %13, align 8, !dbg !114
  ret void, !dbg !114
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !115 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !119 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !123 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !125, metadata !DIExpression()), !dbg !127
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !128, metadata !DIExpression()), !dbg !127
  %0 = load i8*, i8** %vtt, align 8, !dbg !131
  %1 = bitcast %class.BB* %this to i32 (...)***, !dbg !131
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !131
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !131
  ret void, !dbg !131
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !132 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !134, metadata !DIExpression()), !dbg !136
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !137, metadata !DIExpression()), !dbg !136
  %0 = load i8*, i8** %vtt, align 8, !dbg !138
  %1 = bitcast %class.CC* %this to i32 (...)***, !dbg !138
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !138
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !138
  ret void, !dbg !138
}
