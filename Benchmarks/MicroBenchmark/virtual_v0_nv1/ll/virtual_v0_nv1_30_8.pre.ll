...
define dso_local void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dptr, i64 %mfptr.coerce0, i64 %mfptr.coerce1) #0 !dbg !172 {
entry:
  ...
  call void @llvm.dbg.value(metadata %class.DD* %dptr, metadata !179, metadata !DIExpression()), !dbg !180
  call void @llvm.dbg.value(metadata { i64, i64 } %mfptr1, metadata !181, metadata !DIExpression()), !dbg !180
  %memptr.adj = extractvalue { i64, i64 } %mfptr1, 1, !dbg !182
  %2 = bitcast %class.DD* %dptr to i8*, !dbg !182
  %3 = getelementptr inbounds i8, i8* %2, i64 %TIPS_load_01, !dbg !182
  %this.adjusted = bitcast i8* %3 to %class.DD*, !dbg !182
  %memptr.ptr = extractvalue { i64, i64 } %mfptr1, 0, !dbg !182
  %4 = and i64 %TIPS_load_00, 1, !dbg !182
  %memptr.isvirtual = icmp ne i64 %4, 0, !dbg !182
  br i1 %memptr.isvirtual, label %memptr.virtual, label %memptr.nonvirtual, !dbg !182

memptr.virtual:                                   ; preds = %entry
  %5 = bitcast %class.DD* %this.adjusted to i8**, !dbg !182
  %vtable = load i8*, i8** %5, align 8, !dbg !182
  %6 = sub i64 %TIPS_load_00, 1, !dbg !182
  %7 = getelementptr i8, i8* %vtable, i64 %6, !dbg !182, !nosanitize !178
  %8 = bitcast i8* %7 to void (%class.DD*)**, !dbg !182, !nosanitize !178
  %memptr.virtualfn = load void (%class.DD*)*, void (%class.DD*)** %8, align 8, !dbg !182, !nosanitize !178
  br label %memptr.end, !dbg !182

memptr.nonvirtual:                                ; preds = %entry
  %memptr.nonvirtualfn = inttoptr i64 %TIPS_load_00 to void (%class.DD*)*, !dbg !182
  br label %memptr.end, !dbg !182

memptr.end:                                       ; preds = %memptr.nonvirtual, %memptr.virtual
  %9 = phi void (%class.DD*)* [ %memptr.virtualfn, %memptr.virtual ], [ %memptr.nonvirtualfn, %memptr.nonvirtual ], !dbg !182
  call void %9(%class.DD* noundef nonnull align 8 dereferenceable(40) %this.adjusted) #5, !dbg !182
  ret void, !dbg !183
}
...
define dso_local noundef i32 @main() #2 !dbg !184 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %class.DD* %dobj, metadata !185, metadata !DIExpression()), !dbg !186
  call void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %dobj) #6, !dbg !186
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000000Ev to i64), i64 0 }, { i64, i64 }* %coerce, align 8, !dbg !187
  %1 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce, i32 0, i32 0, !dbg !187
  %2 = load i64, i64* %1, align 8, !dbg !187
  %3 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce, i32 0, i32 1, !dbg !187
  %4 = load i64, i64* %3, align 8, !dbg !187
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %2, i64 %4) #5, !dbg !187
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000001Ev to i64), i64 0 }, { i64, i64 }* %coerce1, align 8, !dbg !188
  %6 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce1, i32 0, i32 0, !dbg !188
  %7 = load i64, i64* %6, align 8, !dbg !188
  %8 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce1, i32 0, i32 1, !dbg !188
  %9 = load i64, i64* %8, align 8, !dbg !188
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %7, i64 %9) #5, !dbg !188
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000002Ev to i64), i64 0 }, { i64, i64 }* %coerce2, align 8, !dbg !189
  %11 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce2, i32 0, i32 0, !dbg !189
  %12 = load i64, i64* %11, align 8, !dbg !189
  %13 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce2, i32 0, i32 1, !dbg !189
  %14 = load i64, i64* %13, align 8, !dbg !189
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %12, i64 %14) #5, !dbg !189
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000003Ev to i64), i64 0 }, { i64, i64 }* %coerce3, align 8, !dbg !190
  %16 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce3, i32 0, i32 0, !dbg !190
  %17 = load i64, i64* %16, align 8, !dbg !190
  %18 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce3, i32 0, i32 1, !dbg !190
  %19 = load i64, i64* %18, align 8, !dbg !190
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %17, i64 %19) #5, !dbg !190
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000004Ev to i64), i64 0 }, { i64, i64 }* %coerce4, align 8, !dbg !191
  %21 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce4, i32 0, i32 0, !dbg !191
  %22 = load i64, i64* %21, align 8, !dbg !191
  %23 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce4, i32 0, i32 1, !dbg !191
  %24 = load i64, i64* %23, align 8, !dbg !191
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %22, i64 %24) #5, !dbg !191
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000005Ev to i64), i64 0 }, { i64, i64 }* %coerce5, align 8, !dbg !192
  %26 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce5, i32 0, i32 0, !dbg !192
  %27 = load i64, i64* %26, align 8, !dbg !192
  %28 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce5, i32 0, i32 1, !dbg !192
  %29 = load i64, i64* %28, align 8, !dbg !192
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %27, i64 %29) #5, !dbg !192
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000006Ev to i64), i64 0 }, { i64, i64 }* %coerce6, align 8, !dbg !193
  %31 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce6, i32 0, i32 0, !dbg !193
  %32 = load i64, i64* %31, align 8, !dbg !193
  %33 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce6, i32 0, i32 1, !dbg !193
  %34 = load i64, i64* %33, align 8, !dbg !193
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %32, i64 %34) #5, !dbg !193
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000007Ev to i64), i64 0 }, { i64, i64 }* %coerce7, align 8, !dbg !194
  %36 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce7, i32 0, i32 0, !dbg !194
  %37 = load i64, i64* %36, align 8, !dbg !194
  %38 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce7, i32 0, i32 1, !dbg !194
  %39 = load i64, i64* %38, align 8, !dbg !194
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %37, i64 %39) #5, !dbg !194
  ret i32 0, !dbg !195
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #3 comdat align 2 !dbg !196 {
entry:
  call void @llvm.dbg.value(metadata %class.DD* %this, metadata !198, metadata !DIExpression()), !dbg !199
  %0 = bitcast %class.DD* %this to i8*, !dbg !200
  %1 = getelementptr inbounds i8, i8* %0, i64 40, !dbg !200
  %2 = bitcast i8* %1 to %class.AA*, !dbg !200
  %3 = bitcast %class.DD* %this to %class.BB*, !dbg !200
  %4 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 1
  call void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %3, i8** noundef %4) #6, !dbg !200
  %5 = bitcast %class.DD* %this to i8*, !dbg !200
  %6 = getelementptr inbounds i8, i8* %5, i64 16, !dbg !200
  %7 = bitcast i8* %6 to %class.CC*, !dbg !200
  %8 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 2
  call void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %7, i8** noundef %8) #6, !dbg !200
  %9 = bitcast %class.DD* %this to i32 (...)***, !dbg !200
  %10 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 0, i32 3
  %11 = bitcast i8** %10 to i32 (...)**
  store i32 (...)** %11, i32 (...)*** %9, align 8, !dbg !200
  %12 = bitcast %class.DD* %this to i8*, !dbg !200
  %add.ptr = getelementptr inbounds i8, i8* %12, i64 16, !dbg !200
  %13 = bitcast i8* %add.ptr to i32 (...)***, !dbg !200
  %14 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 1, i32 3
  %15 = bitcast i8** %14 to i32 (...)**
  store i32 (...)** %15, i32 (...)*** %13, align 8, !dbg !200
  ret void, !dbg !200
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !201 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !205 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !209 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !213 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000004Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !217 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000005Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !221 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000006Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !225 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000007Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !229 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !233 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !235, metadata !DIExpression()), !dbg !237
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !238, metadata !DIExpression()), !dbg !237
  %0 = load i8*, i8** %vtt, align 8, !dbg !241
  %1 = bitcast %class.BB* %this to i32 (...)***, !dbg !241
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !241
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !241
  ret void, !dbg !241
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !242 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !244, metadata !DIExpression()), !dbg !246
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !247, metadata !DIExpression()), !dbg !246
  %0 = load i8*, i8** %vtt, align 8, !dbg !248
  %1 = bitcast %class.CC* %this to i32 (...)***, !dbg !248
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !248
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !248
  ret void, !dbg !248
}
