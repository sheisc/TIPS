...
define linkonce_odr dso_local void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #3 comdat align 2 !dbg !150 {
entry:
  call void @llvm.dbg.value(metadata %class.DD* %this, metadata !152, metadata !DIExpression()), !dbg !153
  %0 = bitcast %class.DD* %this to i8*, !dbg !154
  %1 = getelementptr inbounds i8, i8* %0, i64 40, !dbg !154
  %2 = bitcast i8* %1 to %class.AA*, !dbg !154
  %3 = bitcast %class.DD* %this to %class.BB*, !dbg !154
  %4 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 1
  call void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %3, i8** noundef %4) #6, !dbg !154
  %5 = bitcast %class.DD* %this to i8*, !dbg !154
  %6 = getelementptr inbounds i8, i8* %5, i64 16, !dbg !154
  %7 = bitcast i8* %6 to %class.CC*, !dbg !154
  %8 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 2
  call void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %7, i8** noundef %8) #6, !dbg !154
  %9 = bitcast %class.DD* %this to i32 (...)***, !dbg !154
  %10 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 0, i32 3
  %11 = bitcast i8** %10 to i32 (...)**
  store i32 (...)** %11, i32 (...)*** %9, align 8, !dbg !154
  %12 = bitcast %class.DD* %this to i8*, !dbg !154
  %add.ptr = getelementptr inbounds i8, i8* %12, i64 16, !dbg !154
  %13 = bitcast i8* %add.ptr to i32 (...)***, !dbg !154
  %14 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 1, i32 3
  %15 = bitcast i8** %14 to i32 (...)**
  store i32 (...)** %15, i32 (...)*** %13, align 8, !dbg !154
  ret void, !dbg !154
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !155 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !159 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !163 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !165, metadata !DIExpression()), !dbg !167
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !168, metadata !DIExpression()), !dbg !167
  %0 = load i8*, i8** %vtt, align 8, !dbg !171
  %1 = bitcast %class.BB* %this to i32 (...)***, !dbg !171
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !171
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !171
  ret void, !dbg !171
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !172 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !174, metadata !DIExpression()), !dbg !176
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !177, metadata !DIExpression()), !dbg !176
  %0 = load i8*, i8** %vtt, align 8, !dbg !178
  %1 = bitcast %class.CC* %this to i32 (...)***, !dbg !178
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !178
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !178
  ret void, !dbg !178
}
