...
define dso_local void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dptr, i64 %mfptr.coerce0, i64 %mfptr.coerce1) #0 !dbg !92 {
entry:
  ...
  call void @llvm.dbg.value(metadata %class.DD* %dptr, metadata !99, metadata !DIExpression()), !dbg !100
  call void @llvm.dbg.value(metadata { i64, i64 } %mfptr1, metadata !101, metadata !DIExpression()), !dbg !100
  %memptr.adj = extractvalue { i64, i64 } %mfptr1, 1, !dbg !102
  %2 = bitcast %class.DD* %dptr to i8*, !dbg !102
  %3 = getelementptr inbounds i8, i8* %2, i64 %TIPS_load_01, !dbg !102
  %this.adjusted = bitcast i8* %3 to %class.DD*, !dbg !102
  %memptr.ptr = extractvalue { i64, i64 } %mfptr1, 0, !dbg !102
  %4 = and i64 %TIPS_load_00, 1, !dbg !102
  %memptr.isvirtual = icmp ne i64 %4, 0, !dbg !102
  br i1 %memptr.isvirtual, label %memptr.virtual, label %memptr.nonvirtual, !dbg !102

memptr.virtual:                                   ; preds = %entry
  %5 = bitcast %class.DD* %this.adjusted to i8**, !dbg !102
  %vtable = load i8*, i8** %5, align 8, !dbg !102
  %6 = sub i64 %TIPS_load_00, 1, !dbg !102
  %7 = getelementptr i8, i8* %vtable, i64 %6, !dbg !102, !nosanitize !98
  %8 = bitcast i8* %7 to void (%class.DD*)**, !dbg !102, !nosanitize !98
  %memptr.virtualfn = load void (%class.DD*)*, void (%class.DD*)** %8, align 8, !dbg !102, !nosanitize !98
  br label %memptr.end, !dbg !102

memptr.nonvirtual:                                ; preds = %entry
  %memptr.nonvirtualfn = inttoptr i64 %TIPS_load_00 to void (%class.DD*)*, !dbg !102
  br label %memptr.end, !dbg !102

memptr.end:                                       ; preds = %memptr.nonvirtual, %memptr.virtual
  %9 = phi void (%class.DD*)* [ %memptr.virtualfn, %memptr.virtual ], [ %memptr.nonvirtualfn, %memptr.nonvirtual ], !dbg !102
  call void %9(%class.DD* noundef nonnull align 8 dereferenceable(40) %this.adjusted) #5, !dbg !102
  ret void, !dbg !103
}
...
define dso_local noundef i32 @main() #2 !dbg !104 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %class.DD* %dobj, metadata !105, metadata !DIExpression()), !dbg !106
  call void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %dobj) #6, !dbg !106
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000000Ev to i64), i64 0 }, { i64, i64 }* %coerce, align 8, !dbg !107
  %1 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce, i32 0, i32 0, !dbg !107
  %2 = load i64, i64* %1, align 8, !dbg !107
  %3 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce, i32 0, i32 1, !dbg !107
  %4 = load i64, i64* %3, align 8, !dbg !107
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %2, i64 %4) #5, !dbg !107
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000001Ev to i64), i64 0 }, { i64, i64 }* %coerce1, align 8, !dbg !108
  %6 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce1, i32 0, i32 0, !dbg !108
  %7 = load i64, i64* %6, align 8, !dbg !108
  %8 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce1, i32 0, i32 1, !dbg !108
  %9 = load i64, i64* %8, align 8, !dbg !108
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %7, i64 %9) #5, !dbg !108
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000002Ev to i64), i64 0 }, { i64, i64 }* %coerce2, align 8, !dbg !109
  %11 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce2, i32 0, i32 0, !dbg !109
  %12 = load i64, i64* %11, align 8, !dbg !109
  %13 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce2, i32 0, i32 1, !dbg !109
  %14 = load i64, i64* %13, align 8, !dbg !109
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %12, i64 %14) #5, !dbg !109
  ...
  store { i64, i64 } { i64 ptrtoint (void (%class.DD*)* @_ZN2DD14ff_nv_00000003Ev to i64), i64 0 }, { i64, i64 }* %coerce3, align 8, !dbg !110
  %16 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce3, i32 0, i32 0, !dbg !110
  %17 = load i64, i64* %16, align 8, !dbg !110
  %18 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %coerce3, i32 0, i32 1, !dbg !110
  %19 = load i64, i64* %18, align 8, !dbg !110
  call void @_Z4testP2DDMS_FvvE(%class.DD* noundef %dobj, i64 %17, i64 %19) #5, !dbg !110
  ret i32 0, !dbg !111
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DDC1Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) unnamed_addr #3 comdat align 2 !dbg !112 {
entry:
  call void @llvm.dbg.value(metadata %class.DD* %this, metadata !114, metadata !DIExpression()), !dbg !115
  %0 = bitcast %class.DD* %this to i8*, !dbg !116
  %1 = getelementptr inbounds i8, i8* %0, i64 40, !dbg !116
  %2 = bitcast i8* %1 to %class.AA*, !dbg !116
  %3 = bitcast %class.DD* %this to %class.BB*, !dbg !116
  %4 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 1
  call void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %3, i8** noundef %4) #6, !dbg !116
  %5 = bitcast %class.DD* %this to i8*, !dbg !116
  %6 = getelementptr inbounds i8, i8* %5, i64 16, !dbg !116
  %7 = bitcast i8* %6 to %class.CC*, !dbg !116
  %8 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT2DD, i64 0, i64 2
  call void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %7, i8** noundef %8) #6, !dbg !116
  %9 = bitcast %class.DD* %this to i32 (...)***, !dbg !116
  %10 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 0, i32 3
  %11 = bitcast i8** %10 to i32 (...)**
  store i32 (...)** %11, i32 (...)*** %9, align 8, !dbg !116
  %12 = bitcast %class.DD* %this to i8*, !dbg !116
  %add.ptr = getelementptr inbounds i8, i8* %12, i64 16, !dbg !116
  %13 = bitcast i8* %add.ptr to i32 (...)***, !dbg !116
  %14 = getelementptr inbounds { [3 x i8*], [3 x i8*] }, { [3 x i8*], [3 x i8*] }* @_ZTV2DD, i32 0, i32 1, i32 3
  %15 = bitcast i8** %14 to i32 (...)**
  store i32 (...)** %15, i32 (...)*** %13, align 8, !dbg !116
  ret void, !dbg !116
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !117 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !121 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000002Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !125 {
entry:
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000003Ev(%class.DD* noundef nonnull align 8 dereferenceable(40) %this) #4 comdat align 2 !dbg !129 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2BBC2Ev(%class.BB* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !133 {
entry:
  call void @llvm.dbg.value(metadata %class.BB* %this, metadata !135, metadata !DIExpression()), !dbg !137
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !138, metadata !DIExpression()), !dbg !137
  %0 = load i8*, i8** %vtt, align 8, !dbg !141
  %1 = bitcast %class.BB* %this to i32 (...)***, !dbg !141
  %2 = bitcast i8* %0 to i32 (...)**, !dbg !141
  store i32 (...)** %2, i32 (...)*** %1, align 8, !dbg !141
  ret void, !dbg !141
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2CCC2Ev(%class.CC* noundef nonnull align 8 dereferenceable(16) %this, i8** noundef %vtt) unnamed_addr #3 comdat align 2 !dbg !142 {
entry:
  call void @llvm.dbg.value(metadata %class.CC* %this, metadata !144, metadata !DIExpression()), !dbg !146
  call void @llvm.dbg.value(metadata i8** %vtt, metadata !147, metadata !DIExpression()), !dbg !146
  %0 = load i8*, i8** %vtt, align 8, !dbg !148
  %1 = bitcast %class.CC* %this to i32 (...)***, !dbg !148
