...
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000000Ev(%class.DD* noundef nonnull align 8 dereferenceable(16) %this) #3 comdat align 2 !dbg !65 {
entry:
  call void @llvm.dbg.value(metadata %class.DD* %this, metadata !66, metadata !DIExpression()), !dbg !67
  ret void, !dbg !68
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN2DD14ff_nv_00000001Ev(%class.DD* noundef nonnull align 8 dereferenceable(16) %this) #3 comdat align 2 !dbg !69 {
entry:
  call void @llvm.dbg.value(metadata %class.DD* %this, metadata !70, metadata !DIExpression()), !dbg !71
  ret void, !dbg !72
}
