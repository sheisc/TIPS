...
ln -s $(pwd)/llvm-14.0.0.obj $(pwd)/SVF.ORIG/llvm-14.0.0.obj
ln -s $(pwd)/llvm-14.0.0.obj $(pwd)/SVF.TIPS/llvm-14.0.0.obj

ln -s $(pwd)/z3.obj $(pwd)/SVF.ORIG/z3.obj
ln -s $(pwd)/z3.obj $(pwd)/SVF.TIPS/z3.obj
